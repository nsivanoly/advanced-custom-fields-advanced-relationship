(function($){
    ...
    acf.fields.advanced_relationship = acf.field.extend({

        type: 'advanced_relationship',
        ...
        focus: function(){
            ...
            // get elements
            this.$el = this.$field.find('.acf-advanced_relationship');
        ...
        */
        ...
        fetch: function(){
            ...
            // add to this.o
            this.o.action = 'acf/fields/advanced_relationship/query';
            ...
            // add message
            this.$choices.find('ul:last').append('<p><i class="acf-loading"></i> ' + acf._e('advanced_relationship', 'loading') + '</p>');
        ...
        render: function( json ){
            ...
            if( !json || !json.results || !json.results.length ) {
                ...
                if( this.o.paged == 1 ) {
                    ...
                    this.$choices.children('.list').append('<p>' + acf._e('advanced_relationship', 'empty') + '</p>');
        ...
        add_item: function( e ){
            ...
            if( this.o.max > 0 ) {
                ...
                if( this.$values.find('.acf-rel-item').length >= this.o.max ) {
                    ...
                    alert( acf._e('advanced_relationship', 'max').replace('{max}', this.o.max) );
